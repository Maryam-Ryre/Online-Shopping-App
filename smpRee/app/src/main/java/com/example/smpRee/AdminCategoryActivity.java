...
public class AdminCategoryActivity extends AppCompatActivity {
    ...
    private Button LogoutBtn, manageProductsBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        manageProductsBtn = (Button)findViewById(R.id.admin_manage_product_btn);
        ...
        sportsTShirts = (ImageView )findViewById(R.id.spors_t_shirts);
